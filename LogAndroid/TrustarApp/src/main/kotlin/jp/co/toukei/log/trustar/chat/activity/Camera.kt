...
class Camera : FragmentActivity() {
    ...
    companion object {
        ...
        fun resolveResult(result: ActivityResult): CameraResult? {
        ...
        fun intentForStartActivity(context: Context, filePath: File, video: Boolean): Intent {
            return context.intentFor<jp.co.toukei.log.trustar.chat.activity.Camera>(
                ARG_TMP_FILE_PATH to filePath.absolutePath,
                ARG_VIDEO_ENABLED to video
            )
        }
