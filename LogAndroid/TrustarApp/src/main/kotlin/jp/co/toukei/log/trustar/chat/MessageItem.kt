...
sealed class MessageItem(
    ...
    @JvmField val id_Compose: String,
) : CompareContent<MessageItem> {

    @JvmField
    val dateStr = if (Config.GMT9.daysBetween(System.currentTimeMillis(), sentDate) == 0) {
        Clock(Config.GMT9.millisAfterOffset(sentDate)).hhmm
    } else {
    ...
    sealed class Pending(
        ...
        class ImgPending(
            ...
            hasPrev: Boolean,
            hasNext: Boolean,
        ) : Pending(userId, pending, hasPrev, hasNext), Image {
            override val imageUri: ImageURI?
                get() = attachmentExt?.file?.let { ImageURI(it.toUri(), false) }
        ...
        class AudioPending(
            ...
            hasPrev: Boolean,
            hasNext: Boolean,
        ) : Pending(userId, pending, hasPrev, hasNext), Audio {
        ...
        class TextPending(
            ...
            hasPrev: Boolean,
            hasNext: Boolean,
        ) : Pending(userId, pending, hasPrev, hasNext), Text {
            override val text = pending.text
            override val text_Compose: String = text
        }
        ...
        class VideoPending(
            ...
            hasPrev: Boolean,
            hasNext: Boolean,
        ) : Pending(userId, pending, hasPrev, hasNext), Video {
            override fun attachmentExt(): AttachmentExt? = attachmentExt
        }
        ...
        class FilePending(
            ...
            hasPrev: Boolean,
            hasNext: Boolean,
        ) : Pending(userId, pending, hasPrev, hasNext), F {
            override fun attachmentExt(): AttachmentExt? = attachmentExt
        }
    }
    ...
    sealed class Sent(
        ...
        //exclude self?
        @JvmField
        val userCountOfRoom_Compose = readers.size
        ...
        class ImgSent(
            ...
            hasPrev: Boolean,
            hasNext: Boolean,
        ) : Sent(userId, msg, user, readers, hasPrev, hasNext), Image {
            private val img = ChatMessage.textAsImg(msg)

            override val imageUri: ImageURI?
                get() = img?.let { ImageURI(it.url.toUri(), true) }
        ...
        class VideoSent(
            ...
            hasPrev: Boolean,
            hasNext: Boolean,
        ) : Sent(userId, msg, user, readers, hasPrev, hasNext), Video {
        ...
        class AudioSent(
            ...
            hasPrev: Boolean,
            hasNext: Boolean,
        ) : Sent(userId, msg, user, readers, hasPrev, hasNext), Audio {
            override fun attachmentExt(): AttachmentExt? = attachmentExt
        }
        ...
        class TextSent(
            ...
            hasPrev: Boolean,
            hasNext: Boolean,
        ) : Sent(userId, msg, user, readers, hasPrev, hasNext), Text {
            override val text_Compose: String? = msg.text
...
//                }
        ...
        class FileSent(
            ...
            hasPrev: Boolean,
            hasNext: Boolean,
        ) : Sent(userId, msg, user, readers, hasPrev, hasNext), F {
