...
private struct SwiftUITextView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UIKitTextView {
        ...
        view.linkTextAttributes = [.foregroundColor: UIColor.white, .underlineStyle: NSUnderlineStyle.single.rawValue]
...
//            if let tv = view as? UIKitTextView {
//                if let fontSize = tv.font?.pointSize {
//                    let offset = fontSize + 20
//                    newSize = CGSize(width: UIScreen.main.bounds.width, height: (CGFloat(tv.text.count) * fontSize) * offset / UIScreen.main.bounds.width)
//
//                    if newSize.height < offset {
//                        newSize.height = fontSize + 5
//                    }
//                }
//            }
//        }
