...
namespace WinMacOs.DataRepository.BaseProvider
{
    public interface IRepository<TEntity> where TEntity : new()
    {
        ...
        /// <returns></returns>
        //DbSet<TEntity> GetAll(); //Expression<Func<TEntity, T>> selector
        ...
        int Update(TEntity entity, bool saveChanges = false);

        int Update(TEntity entity, string[] properties, bool saveChanges = false);

        int UpdateRange(IEnumerable<TEntity> entities, bool saveChanges = false);
        /// <summary>
        /// 
        /// </summary>
        /// <param name="entity"></param>
        ...
        /// <param name="saveChanges">是否保存</param>
        /// <returns></returns>
        int UpdateRange(IEnumerable<TEntity> models, Expression<Func<TEntity, object>> properties, bool saveChanges = false);

        int UpdateRange(IEnumerable<TEntity> entities, string[] properties, bool saveChanges = false);
        ...
        Task AddAsync(TEntity entities, Expression<Func<TEntity, object>> properties);
