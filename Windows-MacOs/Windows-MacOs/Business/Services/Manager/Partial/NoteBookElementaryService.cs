...
{
    public partial class NoteBookElementaryService
    {

        public Task<NoteBookElementaryModel> GetNoteBookElementaryModel()
        {
            return Task.Factory.StartNew(() => new NoteBookElementaryModel { });
        }
