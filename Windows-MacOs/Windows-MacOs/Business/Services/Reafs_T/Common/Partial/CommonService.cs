...
namespace WinMacOs.Business.Services.Reafs_T
{
    public partial class CommonService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<WebResponseContent> GetMsg(string messageCode)
        {
        ...
        public async Task<WebResponseContent> GetCurrentMenuActionList(string ユーザー種別)
        {
            WebResponseContent responseContent = new WebResponseContent();
        ...
        public async Task<WebResponseContent> GetMenuNameList()
        {
            WebResponseContent responseContent = new WebResponseContent();
        ...
        public async Task<WebResponseContent> Fnc_InsertF090(JArray data)
        {
        ...
        public async Task<WebResponseContent> GetAllMenuActionList()
        {
            WebResponseContent responseContent = new WebResponseContent();
