    ...
    w.Jconfirm.prototype = {
        ...
        _buildHTML: function(){
            ...
            if (this.contentClass)
                template.find('.jconfirm-content-pane').addClass(this.contentClass);
            if (this.containerClass)
                template.find('.jconfirm-box-container').addClass(this.containerClass);
        ...
        _setButtons: function(){
            ...
            $.each(this.buttons, function(key, button){
                ...
                if (key == 'cancel') {
                    that.buttons[key].btnClass = button.btnClass || 'btn-danger';
                    that.buttons[key].keys = button.keys || ['esc'];
                } else if (key == 'confirm' || key == 'ok') {
                    that.buttons[key].btnClass = button.btnClass || 'btn-success';
                    that.buttons[key].keys = button.keys || ['enter'];
                } else {
