...
(function ($, global) {
    ...
    SVG.prototype = TorihikiSVG.prototype
    SVG.prototype.addPath = function (conf) {
        var self = this;
        var options = {
            x: 0,
            y: 0,
    ...
    SVG.prototype.editPath = function (conf) {
        var self = this;
        var Path = self.curPath;
        if (Path == null) {
            return;
...
class PathAction extends Action {
    ...
    doEvent(evt) {
        ...
        if (evt.type === 'pointerdown') {
            ...
            const cPath = this.content.addPath({
                x: this.p.x,
                y: this.p.y,
                x1: this.p.x,
                y1: this.p.y,
            ...
            const svgPath = this.svg.addPath({
                x: this.p.x,
                y: this.p.y,
                x1: this.p.x,
                y1: this.p.y,
            ...
            const cPath = this.content.editPath({
                x: this.p.x,
                y: this.p.y,
                x1: 0,
                y1: 0,
            ...
            const svgPath = this.svg.editPath({
                x: this.p.x,
                y: this.p.y,
                x1: 0,
                y1: 0,
