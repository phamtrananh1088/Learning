...
module.exports = {
  dev: {
    ...
    // host: '10.251.38.99', // can be overwritten by process.env.HOST
    // host: 'localhost', // can be overwritten by process.env.HOST
    // port: 8888, // can be overwritten by process.env.PORT, if port is in use, a free one will be determined
    host: webconfig.client_host, // can be overwritten by process.env.HOST
    port: webconfig.client_port, // can be overwritten by process.env.PORT, if port is in use, a free one will be determined
