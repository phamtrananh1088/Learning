<template>
  ...
  >
    <el-form :model="rowData" :inline="false" ref="rowData" label-width="60px">
      <el-form-item label="件名" prop="TITLE" class="textarea-class">
        <el-input
      ...
      <el-form-item label="掲載日" prop="KEIJI_S_YMD">
        <el-input v-model="rowData.KEIJI_S_YMD" :readonly="true"></el-input>
      </el-form-item>
      <el-form-item label="登録者" prop="TOUROKU_USER" class="textarea-class">
        <el-input v-model="rowData.TOUROKU_USER"  type="textarea" :readonly="true"></el-input>
      </el-form-item>
      <el-form-item label="添付" prop="TENPU">
      ...
      >
      <el-form-item label="詳細" prop="DETAIL" class="textarea-class">
        <el-input
          v-model="rowData.DETAIL"
          :readonly="true"
          type="textarea"
          :autosize="{ minRows: 2 }"
        ></el-input>
    ...
    onDownLoadFile(obj) {
      ...
      this.http
        ...
        .then(async blob => {
          ...
          // link.href = url;
          // link.setAttribute("download", $thisValue.rowData.TENPU_FILENAME);
