    ...
    <div v-show="menuLeftShow" class="main-aside" :style="{ width: menuWidth + 'px' }">
      <div class="main-menu">
        <el-scrollbar style="height: 100%">
          ...
          <br /><br />
          <i class="el-icon-s-tools" @click="changeTheme('blue')">Reafs-W</i
          ><br />
          <i class="el-icon-s-tools" @click="changeTheme('green')">Reafs-R</i
          ><br />
    ...
    <div class="main-container" :style="{ left: menuLeftShow ? menuWidth - 1 + 'px' : 0 }">
      <div class="main-content">
        <el-scrollbar style="height: 100%;" :wrapClass="isCollapse?'wrap-class-sidehide':'wrap-class'">
          ...
          ></router-view>
          <Manual :dialogVisible.sync="showDialogManual"></Manual>
        </el-scrollbar>
      </div>
    </div>
  </div>
